...
SRC_URI="https://github.com/Ultimaker/Cura/releases/download/${PV}/UltiMaker-Cura-${PV}-linux-modern.AppImage
...
src_install() {
  ...
  cp ${DISTDIR}/UltiMaker-Cura-${PV}-linux-modern.AppImage ${PN} || die
  dobin ${PN}
